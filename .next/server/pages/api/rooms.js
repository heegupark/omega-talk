...
module.exports = __webpack_require__("x02F");
...
const Room = mongoose__WEBPACK_IMPORTED_MODULE_0___default.a.models.Room || mongoose__WEBPACK_IMPORTED_MODULE_0___default.a.model('Room', roomSchema);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _middleware_models_room__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("PMmI");
...
/* harmony default export */ __webpack_exports__["default"] = (async (request, response) => {
  ...
  try {
    const rooms = await _middleware_models_room__WEBPACK_IMPORTED_MODULE_0__[/* default */ "a"].find().sort({
      updatedAt: -1
